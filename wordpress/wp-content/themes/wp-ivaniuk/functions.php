...
function wpeHeaderScripts() {
  ...
  wp_register_script('bootstrap', '//cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.1/js/bootstrap.min.js', array(), '3.3.1', true);
  wp_enqueue_script('bootstrap');

  wp_register_script('fontawesome', '//kit.fontawesome.com/c5cf8e42e3.js', array(), '1.0.0', true);
